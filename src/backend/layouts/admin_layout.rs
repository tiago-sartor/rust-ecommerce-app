                    ...
                    <header
                        ...
                        <div
                            ...
                            <div
                                ...
                                <button
                                    class="z-99999 flex h-10 w-10 items-center justify-center rounded-lg text-neutral-750 hover:bg-neutral-100 lg:hidden  "
                                    ...
                                    <form>
                                        <div class="relative">
                                            ...
                                            <input
                                                ...
                                                id="search-input"
                                                class=" shadow-xs focus:border-brand-300 focus:ring-brand-500/10  h-11 w-full rounded-lg border border-neutral-200 bg-transparent py-2.5 pr-14 pl-12 text-sm placeholder:text-neutral-400 focus:ring-3 focus:outline-hidden xl:w-[430px] " />
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <div class="2xsm:gap-3 flex items-center gap-2">
                                    ...
                                    <div
                                        ...
                                        <button
                                            class="relative flex h-11 w-11 items-center justify-center rounded-full border border-neutral-200 bg-white text-neutral-500 transition-colors hover:bg-neutral-100 hover:text-neutral-750"
                                        ...
                                        <div
                                                    ...
                                                    <a
                                                        ...
                                                        <span class="block">
                                                            <span
                                                                ...
                                                                <span class="font-medium ">"Terry Franci"</span>
                                                                " requests permission to change "
                                                                <span class="font-medium ">"Project - Nganter App"</span>
                                                            </span>
                                                ...
                                                <li>
                                                    <a
                                                        ...
                                                        <span class="block">
                                                            <span
                                                                class="text-sm mb-1.5 block text-neutral-500 ">
                                                                <span class="font-medium ">"Alena Franci"</span>
                                                                " requests permission to change "
                                                                <span class="font-medium ">"Project - Nganter App"</span>
                                                            </span>
                                                ...
                                                <li>
                                                    <a
                                                        ...
                                                        <span class="block">
                                                            <span
                                                                class="text-sm mb-1.5 block text-neutral-500 ">
                                                                <span class="font-medium ">"Jocelyn Kenter"</span>
                                                                " requests permission to change "
                                                                <span class="font-medium ">"Project - Nganter App"</span>
                                                            </span>
                                                ...
                                                <li>
                                                    <a
                                                        ...
                                                        <span class="block">
                                                            <span
                                                                class="text-sm mb-1.5 block text-neutral-500 ">
                                                                <span class="font-medium ">"Brandon Philips"</span>
                                                                " requests permission to change "
                                                                <span class="font-medium ">"Project - Nganter App"</span>
                                                            </span>
                                            ...
                                            <a
                                                href="#"
                                                class="text-sm shadow-xs mt-3 flex justify-center rounded-lg border border-neutral-300 bg-white p-3 font-medium text-neutral-750 hover:bg-neutral-50">
                                ...
                                >
                                    <a
                                        class="flex items-center text-neutral-750 "
                                        href="#"
                                    ...
                                    <div
                                        ...
                                        <div>
                                            <span class="text-sm block font-medium text-neutral-750">
                                                (admin.first_name)" "(admin.last_name)
                                            </span>
                                        ...
                                        <ul class="flex flex-col gap-1 border-b border-neutral-200 pt-4 pb-3 ">
                                            <li>
                                                <a href="/admin/account" class="group text-sm flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-neutral-750 hover:bg-neutral-100 hover:text-neutral-750">
                                                    <svg class="fill-neutral-500 group-hover:fill-neutral-750" "fill"="none" "width"="24" "height"="24" "viewBox"="0 0 24 24">
                                        ...
                                        <a href="/admin/logout" class="group text-sm mt-3 flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-neutral-750 hover:bg-neutral-100 hover:text-neutral-750   ">
                                            <svg "fill"="none" class="fill-neutral-500 group-hover:fill-neutral-750 " "width"="24" "height"="24" "viewBox"="0 0 24 24">
